...
function draw(data) {
 ...
 //        .text("Running Log");
	...
	// svg.append('g').attr('transform', 'translate(0,' + plotHeight + ')').call(d3.axisBottom(x).tickValues(function(i) {return monthDays[i]} ));
	// svg.append('g').attr('transform', 'translate(0,' + plotHeight + ')').call(d3.axisBottom(x).ticks(d3.timeMonths));
